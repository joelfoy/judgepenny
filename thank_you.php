...
<p><img src="/images/fail.png"><b><font color="red">The reCAPTCHA wasn't entered correctly. Try it again</font></b></p>

<form  onsubmit="return validate(this);" name="formvalidation" method="POST" action="thank_you.php" id="formvalidation" >
...
<table width="100%" border="0" cellspacing="4" cellpadding="4">
  <tr>
    ...
    <td width="70%"> <span id="sprytextfield1">
      <input autocomplete="off" id="Field4" name="Field4" value="" size="18" tabindex="1" type="text">
       </span></td>
  </tr>
  <tr>
...
<?php
			...
			'<td style="text-align:right;"><strong>Event Date:</strong></td>'.
				'<td>'.$_POST['Field8-2'].'/'.$_POST['Field8-1'].'/'.$_POST['Field8'].'</td>'.
			...
			//send mail to admin
			//mail('Contact Us <info@judgepenny.com>', 'Thank you for Position form data',$msgemail,$headers);
			
			//mail('testddn@gmail.com', 'Thank you for Position form data',$msgemail,$headers);
			mail('marmourjr@gmail.com', 'Thank you for Position form data',$msgemail,$headers);
			header('Location: speaking-requests.php?thank-you');
			?>
